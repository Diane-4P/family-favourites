...
class BookATableForm(forms.ModelForm):
    ...
    class Meta:
        model = BookATable
        fields = [
            'date', 'time', 'number_of_guests', 'first_name', 'last_name',
            'email', 'phonenumber', 'occasion', 'special_requests']
        labels = {
...
class BookATableFormAdmin(forms.ModelForm):
    ...
    class Meta:
        model = BookATable
        fields = [
            'date', 'time', 'number_of_guests', 'user', 'first_name',
            'last_name', 'email', 'phonenumber', 'occasion',
